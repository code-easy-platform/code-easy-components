...
interface SelectorAreaProps {
    ...
    startTop: number
    startLeft: number
    onMouseUp(e: React.MouseEvent<SVGRectElement, any>): any
}
/** Reinderiza a área de seleção na tela, para que seja possível selecionar diversos itens de uma vez. */
export const SelectorArea: React.FC<SelectorAreaProps> = ({ top = 0, left = 0, startLeft, endLeft, startTop, endTop, onMouseUp = (e: any) => { } }) => {
    return (
        <rect
            y={top}
            x={left}
